...
<?PHP if($flot): ?>
    <script src="../assets/flot/jquery.flot.pack.js" language="javascript" type="text/javascript"></script>
    <!--[if IE]><script language="javascript" type="text/javascript" src="../assets/flot/excanvas.pack.js"></script><![endif]-->
<?PHP endif; ?>
</head>
<body>
<div class="wrapper">
