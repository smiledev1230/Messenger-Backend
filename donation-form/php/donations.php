...
if($_GET['order_by'] == 'amount' && $_GET['order_direction'] == 'desc')
{
    $heading = "Top Donors";
    if(isset($_GET['filter_by']) && trim($_GET['filter_by']) != '' && modDonations::isValidFilterField($_GET['filter_by']))
    {
        $filter_by = $_GET['filter_by'];
        $filter_by = str_replace('_', ' ', $filter_by);
        $filter_by = ucwords($filter_by);
        $heading = $filter_by;
    }
}
?>
